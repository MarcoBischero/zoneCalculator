    ...
    return (
        ...
        >
            <div>
                ...
                {trend && (
                    <div className={cn("flex items-center mt-1 text-xs font-medium", trendUp ? "text-green-500" : "text-destructive")}>
                        <span>{trend}</span>
                    </div>
                )}
            </div>
            {icon && (
                <motion.div
                    ...
                    className="p-2 rounded-lg bg-primary/10 text-primary opacity-80"
                >
                    {icon}
                </motion.div>
            )}
