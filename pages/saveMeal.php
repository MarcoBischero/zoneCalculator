							...
							<fieldset>
								<div class="item">
									<label>
										...
										<input data-validate-length-range="3" id="descMeal" placeholder="ex. Pollo e mele" required="required" />		
									</label>
								...
								<div class="item">
									<label>
										...
										<select id="mealType" size="1" class="required">
								...
								<div class="item">
									<label>
										<span>Note</span>
												<textarea id="note" style="width: 210px; height: 60px;"></textarea>
									</label>
								<div class='tooltip help'>
										<span>?</span>
										<div class='content'>
