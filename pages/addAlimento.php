					...
					<fieldset>
						<div class="item">
							<label>
								...
								<input data-validate-length-range="3" id="desc_alimento" placeholder="ex. Pollo" required="required" />		
							</label>
						...
						<div class="item">
							<label>
								<span>Fonte</span>
									<select name="fonte" id="fonte" class="required">
								    	<option value=''>
								    		---Selezionare Fonte---
								    	</option>
										  <?
						...
						<div class="item">
							<label>
								<span>Proteine 100g</span>
									<input style="border:0; font-weight:bold;" required="required" type="text" id="proteine100" size="5"  value="" />
							</label>
						<div class='tooltip help'>
								<span>?</span>
								<div class='content'>
							...
							<label>
								<span>Grassi 100g</span>
									<input style="border:0; font-weight:bold;" required="required" type="text" id="grassi100" size="5"  value="" />
							</label>
						<div class='tooltip help'>
								<span>?</span>
								<div class='content'>
							...
							<label>
								<span>Carbo 100g</span>
									<input style="border:0; font-weight:bold;" required="required" type="text" id="carboidrati100" size="5"  value="" />
							</label>
						<div class='tooltip help'>
								<span>?</span>
								<div class='content'>
